		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>Official Bins Checker</strong></h4>
...
Swal.fire({ title: "@AforArdi", text: "Join Our Telegram Channel :)", icon: "success", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
